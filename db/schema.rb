...
ActiveRecord::Schema.define(version: 20180722140629) do

  create_table "cbooks", force: :cascade do |t|
    t.string   "title"
    t.string   "image"
    t.string   "authors"
    t.string   "category"
  ...
  create_table "reply2s", force: :cascade do |t|
    t.string   "comment"
    t.integer  "reply_id"
    t.integer  "user_id"
    t.datetime "created_at", null: false
  ...
  add_index "rolls", ["club_id"], name: "index_rolls_on_club_id"
